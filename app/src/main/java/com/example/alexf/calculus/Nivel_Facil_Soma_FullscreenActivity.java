 ...
 */
public class Nivel_Facil_Soma_FullscreenActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel__facil__soma__fullscreen);
        ...
        ImageButton SomMudo = (ImageButton) findViewById(R.id.imageButton);

        SomMudo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (som.isPlaying()) {
                    som.stop();

                } else if (!som.isPlaying()) {
        ...
        Validar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Cont[0] < Max) {
                    ...
                    // Toast.makeText(getApplicationContext(), "Parabéns, Fase Concluída", Toast.LENGTH_LONG).show();
                    Result.setEnabled(false);
                    Calc.setEnabled(false);
                    Avanca.setEnabled(false);

                    final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Nivel_Facil_Soma_FullscreenActivity.this);
                    ...
                    alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent Main = new Intent(Nivel_Facil_Soma_FullscreenActivity.this, Nivel_Facil_FullscreenActivity.class);
                            startActivity(Main);
                            dialog.dismiss();
                            finish();
                        }
        ...
        Avanca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Cont[0] < Max) {
                    ...
                    Rnumber11 = Number1.nextInt(30) + 2;
                    ...
                    db.execSQL("INSERT INTO RecordeFacilSoma (Nome,Idade,Recorde) VALUES('" + nome + "','" + idade + "','" + Certo[0] + "')");
                    som.stop();
                    db.close();
                }
            }
