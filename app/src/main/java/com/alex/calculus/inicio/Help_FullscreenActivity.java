 ...
 */
public class Help_FullscreenActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help__fullscreen);
        ...
        scroll = (TextView) findViewById(R.id.textView13);
