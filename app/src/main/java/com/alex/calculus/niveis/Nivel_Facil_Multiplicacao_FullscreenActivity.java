 ...
 */
public class Nivel_Facil_Multiplicacao_FullscreenActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel__facil__multiplicacao__fullscreen);
        ...
        Validar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int MultiplicaRandom = Valor1 * Valor2;
                final EditText Result = (EditText) findViewById(R.id.TxtResultado);
                final TextView MsgResult = (TextView) findViewById(R.id.lblResultado);
                ...
                if (Cont[0] < Max) {
                    ...
                    if (valor.isEmpty()) {
                        ...
                        if (MultiplicaRandom == intV3) {
                            ...
                            MsgResult.setText("Errado -> " + MultiplicaRandom);
                            Errado[0] += 1;
                    ...
                    Validar.setEnabled(false);
                    Avanca.setEnabled(false);
                    final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Nivel_Facil_Multiplicacao_FullscreenActivity.this);
                    ...
                    alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent Main = new Intent(Nivel_Facil_Multiplicacao_FullscreenActivity.this, Nivel_Facil_FullscreenActivity.class);
                            startActivity(Main);
                            dialog.dismiss();
                            finish();
                        }
        ...
        Avanca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Cont[0] < Max) {
                    ...
                    Rnumber11 = Number1.nextInt(10) + 1;
                    Rnumber22 = Number1.nextInt(10) + 2;
                    ...
                    db.execSQL("INSERT INTO RecordeFacilMultiplicacao (Nome,Idade,Recorde) VALUES('" + nome + "','" + idade + "','" + Certo[0] + "')");
