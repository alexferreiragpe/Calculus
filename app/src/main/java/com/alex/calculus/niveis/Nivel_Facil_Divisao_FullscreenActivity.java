 ...
 */
public class Nivel_Facil_Divisao_FullscreenActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel__facil__divisao__fullscreen);
        ...
        while ((Rnumber1 < Rnumber2) || (Rnumber1 % Rnumber2 != 0) || (Rnumber1 == Rnumber2)) {
            Rnumber2 = Number.nextInt(20) + 2;
            Rnumber1 = Number.nextInt(30) + 1;
        ...
        Validar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int DivisaoRandom = Valor1 / Valor2;
                final EditText Result = (EditText) findViewById(R.id.TxtResultado);
                final TextView MsgResult = (TextView) findViewById(R.id.lblResultado);
                ...
                if (Cont[0] < Max) {
                    ...
                    if (valor.isEmpty()) {
                        ...
                        if (DivisaoRandom == intV3) {
                            ...
                            MsgResult.setText("Errado -> " + DivisaoRandom);
                            Errado[0] += 1;
                    ...
                    final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Nivel_Facil_Divisao_FullscreenActivity.this);
                    ...
                    alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent Main = new Intent(Nivel_Facil_Divisao_FullscreenActivity.this, Nivel_Facil_FullscreenActivity.class);
                            startActivity(Main);
                            dialog.dismiss();
                            finish();
                        }
        ...
        Avanca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Cont[0] < Max) {
                    ...
                    while ((Rnumber11 < Rnumber22) || (Rnumber11 % Rnumber22 != 0) || (Rnumber11 == Rnumber22)) {
                        Rnumber11 = Number1.nextInt(30) + 1;
                        Rnumber22 = Number1.nextInt(20) + 2;
                    ...
                    db.execSQL("INSERT INTO RecordeFacilDivisao (Nome,Idade,Recorde) VALUES('" + nome + "','" + idade + "','" + Certo[0] + "')");
                    db.close();
                }
